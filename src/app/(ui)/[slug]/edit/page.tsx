    ...
    return (
        <div>
            ...
            <section className="border-b-2 border-gray-900">
                ...
                <div className="bg-gray-500 h-28 bg-no-repeat bg-cover bg-center flex justify-center items-center gap-4" style={{ backgroundImage: `url(${user.cover})` }}>
                    <div className="cursor-pointer bg-black/50 flex justify-center items-center size-12 rounded-full">
